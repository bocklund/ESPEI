...
def __getattr__(name):
    # Resolved lazily rather than assigned at module scope so that importing
    # espei.utils does not import distributed.
    if name == "ImmediateClient":
        warnings.warn(
            "espei.utils.ImmediateClient is deprecated. Use espei.parallel.DaskPool instead.",
